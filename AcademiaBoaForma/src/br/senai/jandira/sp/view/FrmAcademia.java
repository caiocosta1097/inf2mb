...
public class FrmAcademia extends JFrame {
	...
	public FrmAcademia() {
		setResizable(false);
		setTitle("Boa Forma");
		setIconImage(Toolkit.getDefaultToolkit().getImage(FrmAcademia.class.getResource("/br/senai/jandira/sp/images/academia.png")));
		...
		painelTabela.setBorder(new TitledBorder(new LineBorder(null), "Clientes:", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(37, 183, 211)));
